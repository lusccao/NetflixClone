...
class HomeViewController: UIViewController {
    ...
    private func configureNavBar() {
        let leftNavBarImageView = UIImageView()
            ...
            leftNavBarImageView.widthAnchor.constraint(equalToConstant: 40).isActive = true
            leftNavBarImageView.heightAnchor.constraint(equalToConstant: 40).isActive = true
            navigationItem.leftBarButtonItem = UIBarButtonItem(customView: leftNavBarImageView)
